...
<body>
    ...
    <form method="post" action="deleteAsset.php">

    <nav style ="text-align: left; background: #eeeeee; box-shadow: 6px 7px 53px -10px rgba(0,0,0,0.44);height: 775px; width: 190px; margin-top: 15px;">
        <ul>
    ...
    <main style="margin-left: 265px; margin-top: 18px; margin-right: 20px; padding: 232px 40px; background-color: #F1F1F1">
       ...
       <span style="font-size: 20px; margin-left: 450px; color: grey"> Asset Type: </span>
       ...
       <select name = "ASSET_TYPE">
        ...
        <span style="font-size: 20px; margin-left: 390px; color: grey"> Asset Subcategory: </span>
        <?php 
        ...
        <br /> <br /><br/>
		<span style="font-size: 20px; margin-left: 400px; color: grey"> Employee Name: </span>
		<textarea name = "EMP_NAME" style="width: 140px; height: 20px; margin-left: 10px; background-color: #E5E5E5"></textarea>
        ...
        <br/> <br/><br/>
        <span style="font-size: 20px; margin-left: 400px; color: grey"> Reason: </span><br/>
        <textarea name = "ASSET_REASON" style="width: 230px; height: 150px; margin-left: 470px; background-color: #E5E5E5"></textarea>
     
        <br/> <br/><br/>
        
        <span style ="top: -10px; margin-left: 515px">
